...
def create_tables(connection, cursor):
    ...
    CONSTRAINT positions_pk PRIMARY KEY ("должность")
    )
    '''
    ...
    CONSTRAINT division_pk PRIMARY KEY ("подразделение")
    )
    '''
    ...
    CONSTRAINT fk1_stuff FOREIGN KEY ("должность") REFERENCES positions("должность") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk2_stuff FOREIGN KEY ("подразделение") REFERENCES division("подразделение") ON DELETE CASCADE ON UPDATE CASCADE 
    )
    '''
    ...
    CONSTRAINT status_pk PRIMARY KEY ("статус")
    )
    '''
    ...
    CONSTRAINT fk3_app FOREIGN KEY ("статус") REFERENCES status("статус") ON DELETE CASCADE ON UPDATE CASCADE
    )
    '''
